...
export default function MobileApp() {
  ...
  const renderHome = () => (
    <div className="flex-1 bg-amber-50 min-h-screen flex flex-col max-w-md mx-auto relative shadow-2xl overflow-hidden">
  ...
  const renderLogin = () => (
    <div className="flex-1 bg-amber-50 min-h-screen flex justify-center items-center p-6 relative max-w-md mx-auto shadow-2xl">
      <button 
  ...
  const renderInfo = () => {
    ...
    return (
      <div className="flex-1 bg-indigo-50 min-h-screen flex flex-col max-w-md mx-auto shadow-2xl overflow-y-auto p-6 pt-12 relative">
        <button 
          onClick={() => setScreen('home')} 
