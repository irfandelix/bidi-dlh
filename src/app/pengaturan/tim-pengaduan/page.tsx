      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-3xl font-black tracking-tight text-slate-900 uppercase">Pengaturan Tim Pengaduan</h2>
              <p className="text-sm font-bold text-slate-600 mt-1">Kelola data personil Pengaduan lapangan.</p>
            </div>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y-4 divide-slate-900">
                {loading ? (
                ...
                ) : personil.filter(p => !p.kategori || p.kategori === 'Tim Pengaduan').length === 0 ? (
                  ...
                  personil.filter(p => !p.kategori || p.kategori === 'Tim Pengaduan').map((item, index) => (
          ...
          <div className="bg-white border-4 border-slate-900 rounded-3xl w-full max-w-lg shadow-[12px_12px_0_0_#0f172a] overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <form onSubmit={handleSave} className="p-6 overflow-y-auto space-y-4">
              <div>
                ...
                <select required value={formData.kategori || 'Tim Pengaduan'} onChange={e => setFormData({...formData, kategori: e.target.value})} className="w-full bg-white border-4 border-slate-900 rounded-xl px-4 py-3 font-bold text-slate-900 focus:outline-none focus:ring-4 focus:ring-teal-300">
