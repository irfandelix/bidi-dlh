          ...
          <div className="bg-surface border border-outline-variant rounded-2xl shadow-sm hover:shadow-md transition-shadow w-full max-w-xl overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4">
              ...
              <div>
                ...
                <input type="text" value={formData.jabatan_dinas} onChange={e => setFormData({...formData, jabatan_dinas: e.target.value})} className="w-full px-4 py-3 bg-surface-container-lowest border border-outline-variant rounded-xl focus:outline-none focus:ring-4 focus:ring-emerald-400/20 font-bold" placeholder="Cth: Fungsional Pengendali Dampak Lingkungan..." />
              </div>
              ...
              <div className="pt-6 flex gap-3 border-t-2 border-outline-variant mt-6">
                ...
                <button type="submit" className="flex-1 py-3 px-4 bg-secondary text-on-secondary hover:bg-emerald-300 text-on-surface font-bold uppercase tracking-widest text-xs rounded-xl shadow-sm hover:shadow-md transition-shadow hover:translate-y-1 border border-outline-variant transition-all">
                  Simpan
                </button>
              </div>
            </form>
