            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y-4 divide-slate-900">
                {loading ? (
                  ...
                  <tr><td colSpan={6} className="p-10 text-center text-on-surface-variant font-bold uppercase tracking-widest">Belum ada data tim pengawas.</td></tr>
                ) : (
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y-4 divide-slate-900">
                {loading ? (
                  ...
                  <tr><td colSpan={6} className="p-10 text-center text-on-surface-variant font-bold uppercase tracking-widest">Belum ada data saksi.</td></tr>
                ) : (
